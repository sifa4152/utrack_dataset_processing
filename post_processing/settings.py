...
# INPUTS
LSM_PATH = os.path.join('data', 'era5_reanalysis', 'era5_lsm', 'era5_lsm_remap_utrack.nc')
PATH_TARGET_ZONES = os.path.join('data', 'study_regions', 'countries', 'CNTR_OC_mask_EUROSTAT_GOaS', 'CNTR_OC_mask_EUROSTAT_GOaS.nc')
GRID_PATH = os.path.join('data', 'era5_reanalysis', 'era5_grid_area', 'era5_grid_area_m2_utrack.nc')
PRECIP_PATH = os.path.join('data', 'era5_reanalysis', 'era5_precipitation', 'era5_monthly_tp_1979_2021_mm_month_remap.nc')
EVAP_PATH = os.path.join('data','era5_reanalysis','era5_evaporation','era5_monthly_evap_1979_2021_mm_month_remap.nc') 


# FOOTPRINTS
PATH_MOISTURE_FOOTPRINTS = os.path.join('output_dir','moisture_footprints')
...
# PROCESS OUTPUTS
OUT = os.path.join('output_dir', 'watershed_processing')
